...
gen.train<-gen.data.K3(n.rep, NG, n, theta, cluster_index)
...
save(par.est.all, gen.train, gen.test, file = "ogclust_K3_1000genes_6groups_gamma1_delta3_normal_mediank.rdata")
