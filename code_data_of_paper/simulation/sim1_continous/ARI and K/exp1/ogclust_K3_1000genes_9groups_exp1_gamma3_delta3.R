...
save(par.est.all, gen.train, gen.test, file = "ogclust_K3_1000genes_9groups_exp1_gamma3_delta3.rdata")
...
ARI 
#[1] 0.8538476 0.8883741 0.8699277 0.8800747 0.8606675 0.8755215 0.8773517 0.8656860 0.8840446 0.9073647
median(ARI) #[1] 0.8764366
