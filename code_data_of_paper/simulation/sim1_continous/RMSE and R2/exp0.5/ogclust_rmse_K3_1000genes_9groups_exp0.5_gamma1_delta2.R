...
save(cvres.all, gen.res, file="ogclust_rmse_K3_1000genes_9groups_gamma3_delta5_exp0.5.rdata")
...
#2.410   2.434   2.470   2.463   2.489   2.510 
summary(R2)
#Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#0.6536  0.6724  0.6756  0.6769  0.6825  0.6981  