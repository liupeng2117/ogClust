...
save(cvres.all, gen.res, file="ogclust_rmse_K3_1000genes_9groups_gamma1_delta5_exp0.5.rdata")
...
#2.637   2.688   2.718   2.715   2.749   2.798 
summary(R2)
#Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#0.5644  0.5968  0.6121  0.6077  0.6186  0.6294 