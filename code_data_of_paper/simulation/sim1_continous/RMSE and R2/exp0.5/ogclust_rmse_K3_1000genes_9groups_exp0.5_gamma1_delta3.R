...
save(cvres.all, gen.res, file="ogclust_rmse_K3_1000genes_9groups_gamma1_delta3_exp0.5.rdata")
...
#1.839   1.862   1.904   1.916   1.966   2.013 
summary(R2)
#Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#0.4934  0.5212  0.5488  0.5469  0.5749  0.6036 