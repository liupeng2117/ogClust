...
gamma1=c(3,3,3,3,3,0,0,0,0,0,-3,-3,-3,-3,-3) # 1st set coefficient of genes 1 to 35, others are 0
...
save(res.scluster,gen.train,gen.test,file="survival_scluster_K3_delta2_gamma3.rdata")
