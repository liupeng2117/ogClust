...
# ------- ogclust --------
#-------------------------------
load(file = "survival_ogclust_K3_delta2_gamma3.rdata")
...
y5_prd_ogclust<-ifelse(y5_prd_ogclust<0,0,y5_prd_ogclust)
# ------------------------------
# ------- skmeans --------
#-------------------------------
load(file = "survival_skmeans_K3_delta2_gamma3.rdata")
...
y3_prd_skm<-predict(lo,seq(10,150,5))+0.2
...
# ------- pmbc --------
#-------------------------------
load(file = "survival_pmbc_K3_delta2_gamma3.rdata")
...
y3_prd_pmbc<-predict(lo,seq(10,150,5))+0.2
...
# ------- scluster --------
#-------------------------------
load(file = "survival_scluster_K3_delta2_gamma3.rdata")
...
y3_prd_scluster<-predict(lo,seq(10,150,5))+0.2
