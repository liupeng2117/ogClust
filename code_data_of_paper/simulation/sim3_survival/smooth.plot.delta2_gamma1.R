...
# ------- ogclust --------
#-------------------------------
load(file = "survival_ogclust_K3_delta2_gamma1.rdata")
...
# ------- skmeans --------
#-------------------------------
load(file = "survival_skmeans_K3_delta2_gamma1.rdata")
...
# ------- pmbc --------
#-------------------------------
load(file = "survival_pmbc_K3_delta2_gamma1.rdata")
...
# ------- scluster --------
#-------------------------------
load(file = "survival_scluster_K3_delta2_gamma1.rdata")
