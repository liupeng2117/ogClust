...
# ------- ogclust --------
#-------------------------------
load(file = "survival_ogclust_K3_delta1_gamma3.rdata")
...
# ------- skmeans --------
#-------------------------------
load(file = "survival_skmeans_K3_delta1_gamma3.rdata")
...
# ------- pmbc --------
#-------------------------------
load(file = "survival_pmbc_K3_delta1_gamma3.rdata")
...
# ------- scluster --------
#-------------------------------
load(file = "survival_scluster_K3_delta1_gamma3.rdata")
...
df1=rbind(data.frame(x=seq(10,150,5),y=y_prd_ogclust+0.1,group="ogClust"),
